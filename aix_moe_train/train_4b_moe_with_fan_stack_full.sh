...
CHECKPOINT_PATH=${1:-"${ProjectPath}/checkpoints/4b_moe_bf16_fan_stack"}
TENSORBOARD_LOGS_PATH=${2:-"${ProjectPath}/tensorboard_logs/4b_moe_bf16_fan_stack"}
TOKENIZER_ARG=${3:-"/models/Qwen3-30B-A3B"}
DATA_ARG=${4:-"${ProjectPath}/nemotraon_ccv2_sample_full_processed_data_text_document"}

DATA_CACHE_PATH="${ProjectPath}/data_cache_4b_moe_bf16_fan_stack"
