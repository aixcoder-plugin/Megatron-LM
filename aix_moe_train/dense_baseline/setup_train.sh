...
MICRO_BATCH_SIZE=2
    ...
    --stack-memory-num-heads 8
    --stack-memory-dim 16
TRAIN_SCRIPT_REL="aix_moe_train/dense_baseline/train_10b_full_new.sh" SERVERS="10.103.255.2:0 10.103.255.1:1 10.103.255.4:2 10.103.255.5:3" CONTAINER_NAME_PREFIX="megatron_12b_dense_fan_v_fan_p0.125_stack_dim16" bash aix_moe_train/dense_baseline/run_multi_node.sh

TRAIN_SCRIPT_REL="aix_moe_train/dense_baseline/train_10b_full_new.sh" SERVERS="10.103.255.1:0 10.103.255.4:1 10.103.255.5:2 10.103.255.6:3" CONTAINER_NAME_PREFIX="megatron_12b_dense_fan_v_fan_p0.125_stack_dim16" bash aix_moe_train/dense_baseline/run_multi_node.sh
...
MICRO_BATCH_SIZE=2
    ...
    --stack-memory-num-heads 8
    --stack-memory-dim 16
TRAIN_SCRIPT_REL="aix_moe_train/dense_baseline/train_10b_full_new.sh" SERVERS="10.103.255.1:0 10.103.255.2:1 10.103.255.4:2 10.103.255.6:3" CONTAINER_NAME_PREFIX="megatron_12b_dense_stack_dim16" bash aix_moe_train/dense_baseline/run_multi_node.sh


TRAIN_SCRIPT_REL="aix_moe_train/dense_baseline/train_10b_full_new.sh" SERVERS="10.103.255.1:0 10.103.255.2:1 10.103.255.4:2 10.103.255.6:3" CONTAINER_NAME_PREFIX="megatron_12b_dense_fan_v_fan_p0.125_stack_dim16_2" bash aix_moe_train/dense_baseline/run_multi_node.sh



TRAIN_SCRIPT_REL="aix_moe_train/dense_baseline/train_10b_full_new.sh" SERVERS="10.103.255.1:0 10.103.255.2:1 10.103.255.4:2 10.103.255.5:3 10.103.255.6:4" CONTAINER_NAME_PREFIX="megatron_10b_dense_baseline" bash aix_moe_train/dense_baseline/run_multi_node.sh
...
MICRO_BATCH_SIZE=2
    ...
    --stack-memory-num-heads 8
    --stack-memory-dim 16
TRAIN_SCRIPT_REL="aix_moe_train/dense_baseline/train_10b_full_new.sh" SERVERS="10.103.255.1:0 10.103.255.2:1 10.103.255.4:2 10.103.255.5:3" CONTAINER_NAME_PREFIX="megatron_10b_dense_qk_fan_v_fan_p0.125_stack_dim16" bash aix_moe_train/dense_baseline/run_multi_node.sh